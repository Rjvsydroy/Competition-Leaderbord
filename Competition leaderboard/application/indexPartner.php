...
while($row = mysqli_fetch_array($qrydisplay)){
	...
	echo "<tr><td>".$id."</td><td>".$name."</td><td>".$max_athletes."</td><td>".$num_of_events."</
		...
		<td><a href='edit.php?edit=$id' >Edit</a></td><td><a href='delete.php?deleteid=$id' >Delete</a></td><td><a href='dispEvent.php?dispEvent=$id' >Display events</a></td>
		<td><a href='eventMaker.php?addEvent=$id' >Add events</a></td></tr>";
